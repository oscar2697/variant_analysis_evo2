...
const KnownVariants = ({
    ...
    updateClinvarVariants: (id: string, newVariant: ClinvarVariant) => void
    ...
    const analyzeVariant = async (variant: ClinvarVariant) => {
        ...
        updateClinvarVariants(variant.clinvar_id, {
            ...variant,
            isAnalyzing: true,
        })
        ...
        try {
            ...
            updateClinvarVariants(variant.clinvar_id, updatedVariant)
    ...
    return (
        <Card className="gap-0 border-none bg-white py-0 shadow-sm">
            <CardHeader className="flex flex-row items-center justify-between pt-4 pb-2">
                <CardTitle className="text-sm font-normal text-[#3c4f3d]/70">Known all the Variants in Gene from ClinVar</CardTitle>
            ...
            <CardContent className="pb-4">
                {clinvarError &&
                    <div className="mb-4 rounded-md bg-red-50 p-3 text-xs">
                        {clinvarError}
                    </div>
                }
                    ...
                    <div className="h-96 max-h-96 overflow-y-scroll rounded-md border border-[#3c4f3d]/5">
                        <Table>
                            <TableHeader className="sticky top-0 z-10">
                                <TableRow className="bg-[#e9eeea]/80 hover:bg-[#e9eeea]/60">
                                ...
                                {clinvarVariants.map((variant) => (
                                    ...
                                    >
                                        <TableCell className="py-2">
                                            <div className="text-xs font-medium text-[#3c4f3d]/70">{variant.title} </div>
                                            <div className="mt-1 flex gap-1 items-center text-xs text-[#3c4f3d]/70">
                                                <p>
                                        ...
                                        <TableCell className="py-2 text-xs">{variant.variation_type}</TableCell>
